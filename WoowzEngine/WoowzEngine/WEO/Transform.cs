...
public class Transform : WLI.Packable{
    #region События изменения
        ...
        public event Action<Transform, Vector3F>? OnChangedPosition, OnChangedRotation, OnChangedScale;

    #endregion


    #region Настройки наследования
